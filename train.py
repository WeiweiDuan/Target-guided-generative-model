...
parser.add_argument("--map_path", type=str, default='./data/COWC/Toronto_03553.7.8/Toronto_03553.7.8.jpg')
parser.add_argument("--label_img_dir", type=str, default='./data/COWC/Toronto_03553.7.8/positive')
...
parser.add_argument("--saved_model_dir", type=str, default='./trained_models')
parser.add_argument("--saved_model_name", type=str, default='TGG.h5df')
...
pos_samples_path = args.label_img_dir
map_path = args.map_path
save_detection_path = args.save_detection_folder
SAVE_MODEL_PATH = os.path.join(args.saved_model_dir, args.saved_model_name)
create_folder(save_detection_path)
create_folder(args.saved_model_dir)
...
_x_u, _x_l_aug = process_inputs(all_samples, labele_samples)
...
optimizer = Adam(lr=LEARNING_RATE)
TGG.train_tgg(vae, optimizer, _x_u, _x_l_aug, EPOCHS, SAVE_MODEL_PATH, LOAD_MODEL_PATH)
#######################################################
...
threshold = 0.501
inference(vae, x_test,  x_test_idx, _x_l_aug, threshold, pos_samples_path, save_detection_path, img_size=IMG_SIZE)
#######################################################
